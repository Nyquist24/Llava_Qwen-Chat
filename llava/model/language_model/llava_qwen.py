...
from transformers import AutoConfig, AutoModelForCausalLM, AutoTokenizer, Qwen2Config, Qwen2Model, Qwen2ForCausalLM
...
# AutoTokenizer.register(LlavaConfig, Qwen2Tokenizer)
